													...
													<?php foreach( $value as $event_post) : ?>
														<div class="events__body">
															...
															<div class="events__link">
																<a data-bs-toggle="modal" data-bs-target="#EventModal-<?php echo $i.'-'.$y.'-'.$j;?>" class="btn-one yellow"><span>Réservez votre place</span></a>
															</div>
															<?php endif; ?>
														</div>
														<!-- Modal -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h1 class="f-69 c-yellow title">We Are Free</h1>
